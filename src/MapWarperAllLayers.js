module.exports = L.TileLayer.MapWarperAllLayers = L.TileLayer.Canvas.extend({
  ...
  initialize: function(options) {
    ...
    this._base_url = this.options.base_url;
  ...
  onAdd: function(map) {
    ...
    */
    ...
    this.bigMapsLayer = bigMapsLayer;
    ...
    this.map.addLayer(this.bigMapsLayer);
  ...
  showMap: function(map_id, data) {
    ...
    var old_map = new L.TileLayer.MapWarperLayer(this.map_id, {
      minZoom: 3,
      maxZoom: 20,
    });
  ...
  updateMapMarkers: function(data) {
    ...
    currentLayer.eachLayer(function(layer) {
      ...
      // turn this into some sort of event
  ...
  createMapBounds: function(data) {
    ...
    currentLayer.eachLayer(function(layer) {
      if (me.debug) {
        console.log("Add bounds for map with id ".layer.options.map_id);
      }
      // Turn this into some sort of event
      //      mapList.push(parseInt(layer.options.map_id));
    });
